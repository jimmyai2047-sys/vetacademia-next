        ...
        <CardContent className="space-y-3">
          <div className="grid md:grid-cols-2 gap-3">
            ...
            <div><Label>Type *</Label>
              <Select value={type} onValueChange={(v) => setType(v ?? "POST_MORTEM")}><SelectTrigger><SelectValue /></SelectTrigger><SelectContent><SelectItem value="POST_MORTEM">Post Mortem</SelectItem><SelectItem value="HEALTH_CERTIFICATE">Health Certificate for Export</SelectItem><SelectItem value="OTHER">Other</SelectItem></SelectContent></Select>
            </div>
          </div>
