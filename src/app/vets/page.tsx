...
import { Stethoscope, Sparkles, BookOpen, Users } from "lucide-react";
  ...
  return (
    <div>
            ...
            <>
              ...
              <Link href="/experts">
                <Button variant="secondary" size="sm" className="rounded-full bg-white text-emerald-700 hover:bg-white/90 gap-1.5">
                  <Users className="h-3.5 w-3.5" /> Find Experts
                </Button>
              </Link>
            </>
          }
      ...
      <div className="container mx-auto px-4">
        <div className="va-card-hover relative overflow-hidden rounded-[1.5rem] border border-primary/5 bg-white shadow-sm mt-6">
      ...
      <div id="articles" className="container mx-auto px-4 py-8">
        ...
        <p className="mt-2 text-sm text-muted-foreground">Handpicked for field veterinarians — decorated for focus and clarity.</p>
        <div className="va-divider-dots my-6"><span /></div>
        {vetPosts.length === 0 ? (
