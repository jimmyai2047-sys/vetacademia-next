...
import { ArrowLeft, Crown, Sparkles, FileText } from "lucide-react";
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="inline-flex items-center gap-1.5 rounded-full bg-white/15 backdrop-blur-md border border-white/20 px-2.5 py-0.5 text-[10px] font-bold tracking-widest uppercase">
                <Crown className="h-3 w-3 text-[#d4a843]" /> Royal Proformas
              </div>
              <h1 className="text-2xl font-bold tracking-tight">Veterinarian Proformas</h1>
              <p className="text-white/70 text-sm flex items-center gap-1.5">
                <Sparkles className="h-3.5 w-3.5 text-[#d4a843]" /> Upload Post Mortem and Health Certificate for Export — Word and PDF. Shown on /vets page under Proformas section.
              </p>
            </div>
          </div>
