...
import { FacebookIcon, InstagramIcon, WhatsAppIcon, TelegramIcon } from "@/components/social-icons";
              ...
              <div className="relative">
                ...
                <div className="mt-6 flex flex-col sm:flex-row flex-wrap gap-3 justify-center">
                  <a
                    ...
                    className="inline-flex items-center justify-center rounded-xl bg-[#1877F2] px-5 py-2.5 text-sm font-medium text-white hover:shadow-lg transition-all shadow-md gap-2"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center rounded-xl bg-gradient-to-tr from-[#f9ce34] via-[#ee2a7b] to-[#6228d7] px-5 py-2.5 text-sm font-medium text-white hover:shadow-lg transition-all shadow-md gap-2"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center rounded-xl bg-[#25D366] px-5 py-2.5 text-sm font-medium text-white hover:shadow-lg transition-all shadow-md gap-2"
                  >
                    <WhatsAppIcon className="h-4 w-4" /> WhatsApp Chat
                  </a>
                  <Link
                    href="/community"
                    className="inline-flex items-center justify-center rounded-xl bg-[#229ED9] px-5 py-2.5 text-sm font-medium text-white hover:shadow-lg transition-all shadow-md gap-2"
                  >
                    <TelegramIcon className="h-4 w-4" /> Telegram Groups
                  </Link>
                </div>
                <div className="mt-4">
